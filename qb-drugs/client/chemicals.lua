...
local function createChemicalMenu()
    local chemMenu = {
        ...
        },
        {
			...
			params = {
                event = "qb-drugs:hydrochloric_acid",
            }
        },
        {
            ...
            txt = Lang:t("menu.chemicals"),
			params = {
                event = "qb-drugs:sodium_hydroxide",
            }
        },
        {
...
RegisterNetEvent('qb-drugs:chemicalmenu', createChemicalMenu)
...
local function process_hydrochloric_acid()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('qb-drugs:processHydrochloric_acid')
...
local function process_lsa()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('qb-drugs:process_lsa')
...
local function process_sulfuric_acid()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('qb-drugs:processprocess_sulfuric_acid')
...
local function process_sodium_hydroxide()
	...
	QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.processing"), 15000, false, true, {
		...
		TriggerServerEvent('qb-drugs:processsodium_hydroxide')
...
RegisterNetEvent("qb-drugs:hydrochloric_acid", function()
...
RegisterNetEvent("qb-drugs:lsa", function()
    QBCore.Functions.TriggerCallback('qb-drugs:validate_items', function(result)
		if result then
			process_lsa()
		else
...
RegisterNetEvent("qb-drugs:sulfuric_acid", function()
    QBCore.Functions.TriggerCallback('qb-drugs:validate_items', function(result)
		if result then
...
RegisterNetEvent("qb-drugs:sodium_hydroxide", function()
    QBCore.Functions.TriggerCallback('qb-drugs:validate_items', function(result)
		if result then
...
RegisterNetEvent("qb-drugs:pickChemicals", function()
	local playerPed = PlayerPedId()
	...
	if nearbyObject and IsPedOnFoot(playerPed) then
		...
		QBCore.Functions.Progressbar("search_register", Lang:t("progressbar.pickup_chemicals"), 10000, false, true, {
			...
			TriggerServerEvent('qb-drugs:pickedUpChemicals')
			isPickingUp = false
